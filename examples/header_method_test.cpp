...
int main() {
    try {
        ...
        std::cout << "Content-Type (default 'application/json'): " << ctx.header(http::field::content_type, "application/json") << std::endl;
        ...
        std::cout << client_ip << " - - [25/Dec/2023:10:30:56 +0000] \"GET /api/test HTTP/1.1\" 200 1024 \"" 
                  << referer << "\" \"" << user_agent << "\"" << std::endl;
