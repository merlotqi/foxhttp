...
int main()
{
    try
    {
        ...
        auto detailed_logger =
                std::make_shared<logger_middleware>("DetailedLogger", log_level::debug, log_format::detailed,
                                                    "foxhttp.log"// Log to file
                );

        // Example 3: JSON structured logging
        std::cout << "\n3. JSON Structured Logging:" << std::endl;
        auto json_logger = std::make_shared<logger_middleware>("JsonLogger", log_level::info, log_format::json,
                                                               "foxhttp.json.log");
        ...
        auto perf_logger = std::make_shared<logger_middleware>("PerfLogger", log_level::warn, log_format::simple,
                                                               "performance.log",
