...
std::string plain_text_parser::name() const
{
    return "plaintext";
}

std::string plain_text_parser::content_type() const
{
    return "text/plain";
}
...
const plain_text_config &plain_text_parser::config() const
{
    return core_->config_;
}

void plain_text_parser::set_config(const plain_text_config &config)
{
    core_->config_ = config;
}
